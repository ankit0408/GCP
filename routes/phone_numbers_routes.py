...
from controllers.phone_numbers_controller import get_addresses_by_phone_number, get_entities_by_complete_address, store_contact
...
phone_routes.route('/api/store_address', methods=['POST'])(store_contact)
